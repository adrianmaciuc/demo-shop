  ...
  const milestones = [
    {
      year: "2018",
      event:
        "Founded in Portland, Oregon with a vision to revolutionize shoe retail",
    },
    {
      year: "2019",
      event:
    ...
    <div className="min-h-screen" data-testid="about-page">
          ...
          >
            ...
            >
              ...
              <p>
                ...
                craftsmanship, she set out to create something different—a brand
      ...
      >
        ...
        >
          ...
          <a
            href="/"
            className="inline-block px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 transform hover:scale-105"
            style={{
              backgroundColor: "var(--color-accent)",
              color: "white",
            }}

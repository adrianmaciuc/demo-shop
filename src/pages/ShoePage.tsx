...
const ShoePage = () => {
  ...
  const handleWishlistClick = () => {
    setWishlistParticleActive(true);
    if (inWishlist) {
    ...
    setTimeout(() => setWishlistParticleActive(false), 800);
  };
        ...
        >
          ...
          <div className="space-y-6" data-testid="shoe-info">
            ...
            <div className="space-y-3 pt-4" data-testid="shoe-action-buttons">
              ...
              >
                <ParticleBurst
                  isActive={wishlistParticleActive}
                  particleColor={inWishlist ? "#ff1744" : "#9ca3af"}
                >
                  <motion.button
                    onClick={handleWishlistClick}
                    className={`w-full py-3 border-2 rounded-lg font-medium transition-all flex items-center justify-center gap-2 ${
                      inWishlist
                ...
                <button
                  className="w-full py-3 border-2 border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-all flex items-center justify-center gap-2"
